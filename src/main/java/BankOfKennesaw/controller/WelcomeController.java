...
public class WelcomeController {
    ...
    @PostMapping("/register")
    public String registerUser(@RequestBody BankUser user) 
    		throws Exception {
    ...
    @GetMapping("/JesusTrejoTamayo")
    public  List<BankUser> jesusTrejoTamayo() {
    ...
    public String welcome() {
        return "Welcome to Bank of Kenensaw!!";
    }
